...
<div class="card">
    ...
    <div class="page-actions">
        <a class="btn btn-primary" href="${pageContext.request.contextPath}/inventory/purchase/new">+ 구매요청서 작성</a>
        <a class="btn btn-secondary" href="${pageContext.request.contextPath}/inventory">재고 현황</a>
    </div>
</div>
